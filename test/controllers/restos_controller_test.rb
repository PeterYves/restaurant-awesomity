...
class RestosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resto" do
    assert_difference('Resto.count') do
      post restos_url, params: { resto: { description: @resto.description, image: @resto.image, location: @resto.location, name: @resto.name } }
    end
  ...
  test "should update resto" do
    patch resto_url(@resto), params: { resto: { description: @resto.description, image: @resto.image, location: @resto.location, name: @resto.name } }
